...
def main():
    ...
    # # KF estimate vs Real
    # fig1, ax1 = plt.subplots()    # fig, axs = plt.subplots(m,n) -> axs[m-1,n-1]
    # ax1.scatter(kf_mu_pose[0,:], kf_mu_pose[1,:], label='KF Estimated', color='red', s=2)
    # ax1.scatter(kf_real_pose[0,:], kf_real_pose[1,:],label='KF Real', color='blue', s=2)
    # ax1.legend()

    # # PF estimate vs Real
    # fig2, ax2 = plt.subplots()    # fig, axs = plt.subplots(m,n) -> axs[m-1,n-1]
    # ax2.scatter(pf_mu_pose[0,:], pf_mu_pose[1,:], label='PF Estimated', color='red', s=2)
    # ax2.scatter(pf_real_pose[0,:], pf_real_pose[1,:],label='PF Real', color='blue', s=2)
    # ax2.legend()
    # #####################################################################################

    # Sensor Noise Analysis #############################################################
    fig3, ax3 = plt.subplots()    # fig, axs = plt.subplots(m,n) -> axs[m-1,n-1]
    ax3.scatter(pf_mu_pose[0,:], pf_mu_pose[1,:], label='PF estimate', color='blue', s=2)
    ax3.scatter(kf_mu_pose[0,:], kf_mu_pose[1,:], label='KF estimate', color='red', s=2)
    ax3.legend()
    #####################################################################################
